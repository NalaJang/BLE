...
public class MainActivity extends AppCompatActivity {
    ...
    private Handler requestPacketToProbeHandler = new Handler();
    private final int REQUEST_PACKET_HANDLER_DELAY = 1000;
            ...
            new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        // 리스트에서 선택한 groupPosition -> childPosition 의 값을 가져온다.
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            // 키 LIST_NAME 에 변수 unknownServiceString 값을 넣어준다.
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                // 부모 리스트 중 같은 키 값과 value 값을 찾아 추가한다.
                currentCharaData.put(LIST_NAME, SampleGattAttributes.lookup(uuid, unknownCharaString));
                currentCharaData.put(LIST_UUID, uuid);
                gattCharacteristicGroupData.add(currentCharaData);
            }

            // ArrayList 에 리스트 클릭 시 보여 줄 특성 값들을 넣어준다.
            mGattCharacteristics.add(charas);
            gattCharacteristicData.add(gattCharacteristicGroupData);
        }

        /*
         * 부모 리스트와 자식 리스트를 포함한 adapter 생성
         */
    ...
    public void requestPacketToProbe() {
        Runnable runnable = new Runnable() {
            @Override
            public void run() {

                requestPacketToProbeHandler.postDelayed(this, REQUEST_PACKET_HANDLER_DELAY);

                if( bluetoothLeService != null )
                    bluetoothLeService.writeCharacteristic(2);
            }
        };
        requestPacketToProbeHandler.postDelayed(runnable, REQUEST_PACKET_HANDLER_DELAY);
    }
